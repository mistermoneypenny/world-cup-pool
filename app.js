...
const GROUP_TEAMS = {
  ...
  B: [
    ...
    { seed: 26, name: 'Austria'      },
    { seed: 38, name: 'Honduras'     },
  ],
  C: [
    { seed:  3, name: 'England'      },
    { seed: 15, name: 'USA'          },
  ...
  D: [
    ...
    { seed: 16, name: 'Mexico'       },
    { seed: 28, name: 'Poland'       },
    { seed: 40, name: 'New Zealand'  },
  ],
  E: [
    { seed:  5, name: 'Brazil'       },
    { seed: 17, name: 'Denmark'      },
    { seed: 29, name: 'Canada'       },
    { seed: 41, name: 'South Africa' },
  ],
  F: [
    { seed:  6, name: 'Portugal'     },
    { seed: 18, name: 'Switzerland'  },
    { seed: 30, name: 'Ivory Coast'  },
    { seed: 42, name: 'Ghana'        },
  ],
  G: [
    { seed:  7, name: 'Netherlands'  },
    { seed: 19, name: 'Japan'        },
    { seed: 31, name: 'Venezuela'    },
    { seed: 43, name: 'Tunisia'      },
  ],
  H: [
    { seed:  8, name: 'Belgium'      },
    { seed: 20, name: 'Senegal'      },
    { seed: 32, name: 'Nigeria'      },
    { seed: 44, name: 'Uzbekistan'   },
  ],
  I: [
    { seed:  9, name: 'Italy'        },
